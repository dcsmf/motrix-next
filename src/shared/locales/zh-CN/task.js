export default {
  ...
  'stop-seeding': '停止做种',
  'stop-seeding-tip': '文件已下载完成，正在通过BT分享给其他用户。点击停止做种以结束任务。',
  'task-complete': '已完成',
  'task-error': '出错',
  'task-removed': '已移除',
  'seeding': '做种中',
  ...
  'delete-all-task': '删除所有任务',
  'resume-all-task-success': '恢复所有任务成功',
  'resume-all-task-fail': '恢复所有任务失败',
  'resume-all-task-confirm': '确认恢复所有任务？',
  'pause-all-task-confirm': '确认暂停所有任务？',
  'purge-record-confirm': '确认清除所有已结束记录？',
